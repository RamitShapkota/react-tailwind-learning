                        ...
                        <div className='flex items-start justify-between'>
                            <div className='flex-1'>
                                ...
                                <div className='flex items-center space-x-2'>
                                    ...
                                    <span className='text-sm text-slate-500 dark:text-400'>vs Last month</span>
                                </div>
                            </div>
                            <div className={`p-3 rounded-xl group-hover:scale-110 transition-all duration-200 ${stats.bgColor}`}>
                                {<stats.icon className={`w-6 h-6 ${stats.textColor}`} />}
                            </div>
                        </div>
                        {/* progressbar */}
                        <div className='mt-4 h-2  bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden'>
                            <div className={` bg-gradient-to-r ${stats.color}  rounded-full transition-all duration-500`}
                                style={{
                                    width: stats.trend === "up" ? "75%" : "45%",
                                    height: "100%",
                                }}
