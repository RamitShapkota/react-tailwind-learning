...
function Header({sidebarCollapsed,onToggleSidebar,onToggleDark}) {
    return (
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <div className='hidden md:block'>
                        ...
                        <p className='dark:text-slate-300'>Welcome back, Ramit! here's what's happening today</p>
                    </div>
                </div>
                ...
                <div className='flex items-center space-x-3'>
                    ...
                    {/* user Profile */}
                    <div className='flex items-center space-x-3 pl-3 border-l border-state-200 dark:border-slate-700'>
                        <img 
                        src="https://tse1.mm.bing.net/th/id/OIP.Q8yuUMqU_uigOHQ5DkeOtwHaE8?pid=Api&P=0&h=220"
                         ...
                         className='w-8 h-8 rounded-full ring-2 ring-blue-500'
                          />
                          <div className='hidden md:block'>
                            <p className='text-sm font-medium text-slate-500 dark:text-slate-400'>Ramit Sonar</p>
                            <p className='text-xs text-slate-500 dark:text-slate-400'>Administration</p>
                          </div>
